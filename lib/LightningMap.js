  ...
  _createClass(Lightning, [{
    ...
    value: function attachEvents() {
      ...
      this.canvas.addEventListener('mouseup', function (event) {
        ...
        var latLon = _TileConversion.default.pixelToLatLon(_this.state.moveOffset, _this.options.center, _this.options.zoom, _this.options.canvasDimensions, _this.options.tileSize);

        _this.state.moveOffset = [0, 0];
        _this.options.center = latLon;
