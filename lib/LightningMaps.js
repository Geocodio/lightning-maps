  ...
  _createClass(Map, [{
    ...
    value: function initializeState() {
      this.state = {
        ...
        mouseVelocities: [],
        markerRenderer: new _MarkerRenderer__WEBPACK_IMPORTED_MODULE_3__["default"](),
        polygons: [],
      ...
      if (name === 'mouseup') {
        ...
        if (this.onMarkerClicked) {
          markers.map(function (item) {
            return _this4.onMarkerClicked(item.marker);
          });
        }
      } else {
        if (this.onMarkerHover) {
          markers.map(function (item) {
            return _this4.onMarkerHover(item.marker);
          });
        }
      }
...
function () {
  ...
  _createClass(Marker, [{
    ...
    key: "renderShadow",
    value: function renderShadow(context, position) {
  ...
  _createClass(MarkerRenderer, [{
    ...
    value: function renderOffScreenCanvas(mapState, mapBounds) {
      ...
      visibleMarkers.forEach(function (marker) {
        ...
        marker.render(context, [mapState.canvasCenter[0] - position[0], mapState.canvasCenter[1] - position[1]]);
      });
    }
  }, {
