...
/* harmony import */ var _MarkerRenderer__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MarkerRenderer */ "./src/MarkerRenderer.js");
...
function () {
  function Map(canvas, options) {
    ...
    this.options = Object.assign({}, _defaultOptions__WEBPACK_IMPORTED_MODULE_4__["defaultMapOptions"], options);
  ...
  _createClass(Map, [{
    ...
    value: function initializeState() {
      this.state = {
        ...
        mouseVelocities: [],
        markerRenderer: new _MarkerRenderer__WEBPACK_IMPORTED_MODULE_3__["default"](this.options.markerRenderMode),
        polygons: [],
    ...
    value: function setZoom(zoom) {
      if (this.zoomValueIsValid(zoom) && this.isReadyForZoomEvent()) {
        ...
        this.state.tileLayers.push(new _TileLayer__WEBPACK_IMPORTED_MODULE_1__["default"](this, zoom));
    ...
    value: function attachEvents() {
      ...
      this.canvas.addEventListener('dblclick', function (event) {
        ...
        if (!_this.handleMouseEventInteraction(event, 'dblclick')) {
      ...
      this.canvas.addEventListener('mouseup', function (event) {
        ...
        if (!_this.state.dragStartPosition) {
          ...
          var dragDistanceBelowThreshold = Math.abs(x) <= 5 && Math.abs(y) <= 5;
      ...
      this.canvas.addEventListener('mouseleave', function (event) {
        if (_this.options.hideControlsUntilActive) {
          _this.state.showControls = false;
        }

        _this.updateMousePosition(null);
      });
      this.canvas.addEventListener('mouseenter', function (event) {
        if (_this.options.hideControlsUntilActive) {
          _this.state.showControls = true;
        }
      });
    }
  }, {
    ...
    key: "enablePolygonInteractivity",
    value: function enablePolygonInteractivity() {
    ...
    value: function updateMoveOffset() {
      var targetMoveOffset = this.state.targetMoveOffsetIsCoord ? _TileConversion__WEBPACK_IMPORTED_MODULE_0__["default"].latLonToPixel(this.state.targetMoveOffset, this.options.center, this.options.zoom, this.options.tileSize) : this.state.targetMoveOffset;
      var moveOffsetNeedsToBeUpdated = this.state.moveOffset.join(',') !== targetMoveOffset.join(',');
      ...
      if (moveOffsetNeedsToBeUpdated) {
        ...
        var targetHasBeenReached = this.state.moveOffset.join(',') === targetMoveOffset.join(',');
    ...
    key: "snapshotMapState",
    value: function snapshotMapState() {
      return new _MapState__WEBPACK_IMPORTED_MODULE_2__["default"](this.options.center, this.options.zoom, this.state.targetZoom, this.options.tileSize, this.state.canvasDimensions, this.getCanvasCenter(), this.state.moveOffset);
    }
  }, {
    key: "maxTilesToKeep",
    ...
    value: function draw() {
      ...
      var mapState = this.snapshotMapState();
    ...
    key: "renderMarkers",
    value: function renderMarkers(mapState) {
    ...
    key: "renderPolygons",
    value: function renderPolygons(mapState) {
      var _this3 = this;

      this.state.polygons.map(function (polygon) {
        polygon.render(_this3.context, mapState);

        if (_this3.enablePolygonInteractivity() && !_this3.isCurrentlyDraggingMap()) {
          polygon.handleMouseOver(_this3.context, mapState, _this3.state.mousePosition);
        }
      });
    }
  }, {
    ...
    value: function handleMouseEventInteraction(event, name) {
      ...
      var controlObjects = this.getControlObjects().filter(function (item) {
        return _this4.isMouseOverObject(item.bounds);
      });
      var shouldEmitMarkerEvents = controlObjects.length <= 0 && (this.onMarkerClicked || this.onMarkerHover);
      var markers = shouldEmitMarkerEvents ? this.state.markerRenderer.getMarkersBounds(this.snapshotMapState(), this.getMapBounds()).filter(function (item) {
        return _this4.isMouseOverObject(item.bounds);
      }) : [];
      ...
      var controlsOrMarkersIsHover = controlObjects.length > 0 || firstMarker;
      ...
      if (this.enablePolygonInteractivity() && !this.isCurrentlyDraggingMap() && !controlsOrMarkersIsHover) {
        ...
        polygons = this.state.polygons.map(function (polygon) {
          return {
            polygon: polygon,
            activatedAreas: polygon.handleMouseOver(null, mapState, _this4.state.mousePosition)
          };
        }).filter(function (polygon) {
          return polygon.activatedAreas.length > 0;
        });
        polygonIsHover = polygons.length > 0;

        if (polygonIsHover) {
          var eventHandler = name === 'mouseup' ? this.onPolygonClicked : this.onPolygonHover;

          if (eventHandler) {
            polygons.map(function (polygon) {
              return polygon.activatedAreas.map(function (item) {
                return eventHandler(item, polygon.polygon.meta);
              });
            });
          }
        }
    ...
    value: function renderControls() {
      ...
      if (this.state.showControls) {
        this.getControlObjects().map(function (item) {
          return _this5.renderControl(item.bounds, item.label);
        });
      }
    }
  }, {
    ...
    value: function addMarkers(markers) {
      ...
      markers.map(function (marker) {
        return _this6.addMarker(marker);
      });
    }
  }, {
    key: "addMarker",
...
/*#__PURE__*/
function () {
  function MapState(center, zoom, targetZoom, tileSize, canvasDimensions, canvasCenter, moveOffset) {
...
function () {
  ...
  _createClass(Marker, [{
    key: "render",
    value: function render(context, position, mapZoom) {
    ...
    key: "renderMarker",
    value: function renderMarker(context, position, mapZoom) {
    ...
    key: "renderImage",
    value: function renderImage(context, position, mapZoom) {
    ...
    key: "renderShadow",
    value: function renderShadow(context, position, mapZoom) {
    ...
    get: function get() {
      switch (this.options.type) {
        ...
        case 'circle':
          {
            var strokeMargin = this.options.enableStroke ? this.options.lineWidth : 0;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MarkerRenderer; });
/* harmony import */ var _TileConversion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./TileConversion */ "./src/TileConversion.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
/*#__PURE__*/
function () {
  function MarkerRenderer(renderMode) {
    _classCallCheck(this, MarkerRenderer);
  ...
  _createClass(MarkerRenderer, [{
    ...
    key: "render",
    value: function render(context, mapState, mapBounds) {
      var forceRerender = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
      var originZoom = this.determineOriginZoom(mapState);
      var zoomDiff = originZoom ? mapState.zoom - originZoom : 0;
      var scale = zoomDiff !== 0 ? Math.pow(2, zoomDiff) : 1.0;
      ...
      if (scale < 1.5 || scale > 0.5) {
        var canvasDrawPosition = [mapState.moveOffset[0] - mapState.canvasCenter[0] * (scale - 1), mapState.moveOffset[1] - mapState.canvasCenter[1] * (scale - 1)];
        var canvasDrawDimensions = [mapState.canvasDimensions[0] * scale, mapState.canvasDimensions[1] * scale];
        context.drawImage(this.offscreenCanvas, canvasDrawPosition[0], canvasDrawPosition[1], canvasDrawDimensions[0], canvasDrawDimensions[1]);
      }
    }
  }, {
    key: "shouldReRender",
    value: function shouldReRender(mapState, zoomDiff) {
    ...
    value: function renderOffScreenCanvas(mapState, mapBounds) {
      this.renderedZoomLevel = mapState.zoom;
      this.renderedMapCenter = mapState.center;
      var context = this.createOffscreenCanvas(mapState.canvasDimensions);
      var visibleMarkers = this.getVisibleMarkers(mapBounds);
      visibleMarkers.forEach(function (marker) {
        var position = _TileConversion__WEBPACK_IMPORTED_MODULE_0__["default"].latLonToPixel(marker.coords, mapState.center, mapState.zoom, mapState.tileSize);
        marker.render(context, [mapState.canvasCenter[0] - position[0], mapState.canvasCenter[1] - position[1]], mapState.zoom);
      });
    }
  }, {
    key: "createOffscreenCanvas",
    value: function createOffscreenCanvas(canvasDimensions) {
    ...
    value: function getVisibleMarkers(bounds) {
    ...
    value: function getMarkersBounds(mapState, mapBounds) {
      return this.getVisibleMarkers(mapBounds).map(function (marker) {
        var position = _TileConversion__WEBPACK_IMPORTED_MODULE_0__["default"].latLonToPixel(marker.coords, mapState.center, mapState.zoom, mapState.tileSize);
...
function () {
  ...
  _createClass(Polygon, [{
    ...
    value: function handleMouseOver(context, mapState, mousePosition) {
      ...
      if (!this.options.interactive || !this.geometry || !this.projectedGeometry || currentlyZooming || mousePosition.x < 0 && mousePosition.y < 0) {
        return [];
      }

      var originZoom = this.determineOriginZoom(mapState);
      var centerOffset = this.calculateCenterOffset(mapState, originZoom);
      var point = [mousePosition.x - centerOffset[0] - mapState.canvasCenter[0], mousePosition.y - centerOffset[1] - mapState.canvasCenter[1]];
        ...
        if (isHover && context) {
          ...
          item.geometry.map(function (list) {
            list.map(function (position, index) {
              position = [position[0] + centerOffset[0] + mapState.canvasCenter[0], position[1] + centerOffset[1] + mapState.canvasCenter[1]];
    ...
    value: function render(context, mapState) {
      ...
      if (this.shouldReRender(mapState, zoomDiff)) {
        ...
        var imagePosition = [mapState.canvasCenter[0] + mapState.moveOffset[0] + this.polygonExtends.minX * scale, mapState.canvasCenter[1] + mapState.moveOffset[1] + this.polygonExtends.minY * scale];
        var imageRect = {
      ...
      var imageDrawPosition = [mapState.moveOffset[0] - mapState.canvasCenter[0] * (scale - 1), mapState.moveOffset[1] - mapState.canvasCenter[1] * (scale - 1)];
